...
export default function ResponsiveDialog() {
  ...
  return (
    <div >
      ...
      >
        <DialogTitle id="responsive-dialog-title" className={classes.fondo}>{"Scrum Fundamentals Certified"}</DialogTitle>
        <DialogContent className={classes.fondo}>
            <img src={Scrum} className={classes.scrum} alt="Scrum" />
        </DialogContent>
